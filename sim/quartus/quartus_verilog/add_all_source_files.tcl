...
# Tu sim/quartus/quartus_verilog, len 3 cap de den AXI root
# Duong dan: sim/quartus/quartus_verilog -> .. -> quartus -> .. -> sim -> .. -> AXI
...
# Lua chon 8: Giu nguyen top-level hien tai (KHUYEN NGHI - Khong override)
puts "   ℹ Keeping existing top-level entity (not overriding)\n"
puts "   ℹ Current top-level is set in AXI_PROJECT.qsf\n"
puts "   ℹ Uncomment one of the options above if you want to change it\n"

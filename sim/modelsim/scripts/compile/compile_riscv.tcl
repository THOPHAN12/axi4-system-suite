# ============================================================================
# TCL Script to Compile SERV RISC-V System
# Usage: vsim -c -do "source compile_riscv.tcl; quit -f"
# ============================================================================
...
# Debug: Print paths
puts "\n============================================================================"
puts "Compiling SERV RISC-V System"
puts "============================================================================"
puts "Script directory: $script_dir"
...
if {[catch {vsim -voptargs=+acc work.serv_axi_system_tb} err]} {
    puts "ERROR: Compilation failed or testbench module not found!"
    puts "Error: $err"
    quit -code 1
} else {
    puts "✓ Compilation successful!"
    puts "✓ Testbench module 'serv_axi_system_tb' is ready"
    puts ""
    puts "Next step: Run simulation with 'source run_riscv_sim.tcl'"
    puts "============================================================================"
}

# Don't quit - let user decide whether to run simulation or not
# quit -f

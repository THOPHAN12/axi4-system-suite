...
// 1. SERV core files (serv_*.v)
// 2. AXI Interconnect files
// 3. AXI Master Aggregator
// 4. AXI Bridge files (serv_axi_wrapper.v)
// 5. Peripherals (axi_lite_*.v)
// 6. System files (dual_axi_shell.v, dual_serv_axi_system.v)

module dual_serv_axi_system #(
    ...
    // Debug - SERV 0
    output wire [31:0] serv0_debug_pc,
    output wire [31:0] serv0_debug_r1,
    output wire [31:0] serv0_debug_r2,

    // Debug - SERV 1
    output wire [31:0] serv1_debug_pc,
    output wire [31:0] serv1_debug_r1,
    output wire [31:0] serv1_debug_r2,
    
    // ========================================================================
    // Master Busy Signals
    // ========================================================================
    output wire                          serv0_busy,
    output wire                          serv1_busy
);

// ==============================================================================
// Busy signals from core wrappers
// ==============================================================================
wire serv0_busy_int, serv1_busy_int;

// ==============================================================================
// AXI signals from core wrappers (4 masters)
// ==============================================================================
// SERV core 0
wire [ADDR_WIDTH-1:0] S0_M_ARADDR, S0_M_AWADDR, S0_M_ARADDR_D;
wire [DATA_WIDTH-1:0] S0_M_RDATA, S0_M_RDATA_D, S0_M_WDATA_D;
wire [3:0]            S0_M_WSTRB_D;
wire [1:0]            S0_M_RRESP, S0_M_RRESP_D, S0_M_BRESP_D;
wire                  S0_M_ARVALID, S0_M_ARREADY, S0_M_RVALID, S0_M_RREADY;
wire                  S0_M_AWVALID_D, S0_M_AWREADY_D, S0_M_WVALID_D, S0_M_WREADY_D;
wire                  S0_M_BVALID_D, S0_M_BREADY_D, S0_M_ARVALID_D, S0_M_ARREADY_D, S0_M_RVALID_D, S0_M_RREADY_D;

// SERV core 1
wire [ADDR_WIDTH-1:0] S1_M_ARADDR, S1_M_AWADDR, S1_M_ARADDR_D;
wire [DATA_WIDTH-1:0] S1_M_RDATA, S1_M_RDATA_D, S1_M_WDATA_D;
wire [3:0]            S1_M_WSTRB_D;
wire [1:0]            S1_M_RRESP, S1_M_RRESP_D, S1_M_BRESP_D;
wire                  S1_M_ARVALID, S1_M_ARREADY, S1_M_RVALID, S1_M_RREADY;
wire                  S1_M_AWVALID_D, S1_M_AWREADY_D, S1_M_WVALID_D, S1_M_WREADY_D;
wire                  S1_M_BVALID_D, S1_M_BREADY_D, S1_M_ARVALID_D, S1_M_ARREADY_D, S1_M_RVALID_D, S1_M_RREADY_D;
...
serv_axi_wrapper #(
    ...
    .rst_n(ARESETN),
    // Instruction
    .m_axi_instr_araddr(S0_M_ARADDR),
    .m_axi_instr_arprot(),
    .m_axi_instr_arvalid(S0_M_ARVALID),
    .m_axi_instr_arready(S0_M_ARREADY),
    .m_axi_instr_rdata(S0_M_RDATA),
    .m_axi_instr_rresp(S0_M_RRESP),
    .m_axi_instr_rvalid(S0_M_RVALID),
    .m_axi_instr_rready(S0_M_RREADY),
    // Data
    .m_axi_data_awaddr(S0_M_AWADDR),
    .m_axi_data_awprot(),
    .m_axi_data_awvalid(S0_M_AWVALID_D),
    .m_axi_data_awready(S0_M_AWREADY_D),
    .m_axi_data_wdata(S0_M_WDATA_D),
    .m_axi_data_wstrb(S0_M_WSTRB_D),
    .m_axi_data_wvalid(S0_M_WVALID_D),
    .m_axi_data_wready(S0_M_WREADY_D),
    .m_axi_data_bresp(S0_M_BRESP_D),
    .m_axi_data_bvalid(S0_M_BVALID_D),
    .m_axi_data_bready(S0_M_BREADY_D),
    .m_axi_data_araddr(S0_M_ARADDR_D),
    .m_axi_data_arprot(),
    .m_axi_data_arvalid(S0_M_ARVALID_D),
    .m_axi_data_arready(S0_M_ARREADY_D),
    .m_axi_data_rdata(S0_M_RDATA_D),
    .m_axi_data_rresp(S0_M_RRESP_D),
    .m_axi_data_rvalid(S0_M_RVALID_D),
    .m_axi_data_rready(S0_M_RREADY_D),
    // Debug
    .debug_pc(serv0_debug_pc),
    .debug_r1(serv0_debug_r1),
    .debug_r2(serv0_debug_r2),
    .debug_zero(),
    // Busy
    .o_busy(serv0_busy_int)
);
...
serv_axi_wrapper #(
    ...
    .rst_n(ARESETN),
    // Instruction
    .m_axi_instr_araddr(S1_M_ARADDR),
    .m_axi_instr_arprot(),
    .m_axi_instr_arvalid(S1_M_ARVALID),
    .m_axi_instr_arready(S1_M_ARREADY),
    .m_axi_instr_rdata(S1_M_RDATA),
    .m_axi_instr_rresp(S1_M_RRESP),
    .m_axi_instr_rvalid(S1_M_RVALID),
    .m_axi_instr_rready(S1_M_RREADY),
    // Data
    .m_axi_data_awaddr(S1_M_AWADDR),
    .m_axi_data_awprot(),
    .m_axi_data_awvalid(S1_M_AWVALID_D),
    .m_axi_data_awready(S1_M_AWREADY_D),
    .m_axi_data_wdata(S1_M_WDATA_D),
    .m_axi_data_wstrb(S1_M_WSTRB_D),
    .m_axi_data_wvalid(S1_M_WVALID_D),
    .m_axi_data_wready(S1_M_WREADY_D),
    .m_axi_data_bresp(S1_M_BRESP_D),
    .m_axi_data_bvalid(S1_M_BVALID_D),
    .m_axi_data_bready(S1_M_BREADY_D),
    .m_axi_data_araddr(S1_M_ARADDR_D),
    .m_axi_data_arprot(),
    .m_axi_data_arvalid(S1_M_ARVALID_D),
    .m_axi_data_arready(S1_M_ARREADY_D),
    .m_axi_data_rdata(S1_M_RDATA_D),
    .m_axi_data_rresp(S1_M_RRESP_D),
    .m_axi_data_rvalid(S1_M_RVALID_D),
    .m_axi_data_rready(S1_M_RREADY_D),
    // Debug
    .debug_pc(serv1_debug_pc),
    .debug_r1(serv1_debug_r1),
    .debug_r2(serv1_debug_r2),
    .debug_zero(),
    // Busy
    .o_busy(serv1_busy_int)
);
...
AXI_Master_Aggregator #(
    ...
    .ARESETN(ARESETN),
    // M0 = serv0 instr
    .M0_ARADDR(S0_M_ARADDR), .M0_ARPROT(3'b000), .M0_ARVALID(S0_M_ARVALID), .M0_ARREADY(S0_M_ARREADY),
    .M0_RDATA(S0_M_RDATA), .M0_RRESP(S0_M_RRESP), .M0_RVALID(S0_M_RVALID), .M0_RREADY(S0_M_RREADY),
    ...
    // M1 = serv1 instr
    .M1_ARADDR(S1_M_ARADDR), .M1_ARPROT(3'b000), .M1_ARVALID(S1_M_ARVALID), .M1_ARREADY(S1_M_ARREADY),
    .M1_RDATA(S1_M_RDATA), .M1_RRESP(S1_M_RRESP), .M1_RVALID(S1_M_RVALID), .M1_RREADY(S1_M_RREADY),
...
AXI_Master_Aggregator #(
    ...
    .ARESETN(ARESETN),
    // M0 = serv0 data
    .M0_ARADDR(S0_M_ARADDR_D), .M0_ARPROT(3'b000), .M0_ARVALID(S0_M_ARVALID_D), .M0_ARREADY(S0_M_ARREADY_D),
    .M0_RDATA(S0_M_RDATA_D), .M0_RRESP(S0_M_RRESP_D), .M0_RVALID(S0_M_RVALID_D), .M0_RREADY(S0_M_RREADY_D),
    .M0_AWADDR(S0_M_AWADDR), .M0_AWPROT(3'b000), .M0_AWVALID(S0_M_AWVALID_D), .M0_AWREADY(S0_M_AWREADY_D),
    .M0_WDATA(S0_M_WDATA_D), .M0_WSTRB(S0_M_WSTRB_D), .M0_WVALID(S0_M_WVALID_D), .M0_WREADY(S0_M_WREADY_D),
    .M0_BRESP(S0_M_BRESP_D), .M0_BVALID(S0_M_BVALID_D), .M0_BREADY(S0_M_BREADY_D),
    // M1 = serv1 data
    .M1_ARADDR(S1_M_ARADDR_D), .M1_ARPROT(3'b000), .M1_ARVALID(S1_M_ARVALID_D), .M1_ARREADY(S1_M_ARREADY_D),
    .M1_RDATA(S1_M_RDATA_D), .M1_RRESP(S1_M_RRESP_D), .M1_RVALID(S1_M_RVALID_D), .M1_RREADY(S1_M_RREADY_D),
    .M1_AWADDR(S1_M_AWADDR), .M1_AWPROT(3'b000), .M1_AWVALID(S1_M_AWVALID_D), .M1_AWREADY(S1_M_AWREADY_D),
    .M1_WDATA(S1_M_WDATA_D), .M1_WSTRB(S1_M_WSTRB_D), .M1_WVALID(S1_M_WVALID_D), .M1_WREADY(S1_M_WREADY_D),
    .M1_BRESP(S1_M_BRESP_D), .M1_BVALID(S1_M_BVALID_D), .M1_BREADY(S1_M_BREADY_D),
    // Unused M2
    .M2_ARADDR(32'h0), .M2_ARPROT(3'b0), .M2_ARVALID(1'b0), .M2_ARREADY(),
    .M2_RDATA(), .M2_RRESP(), .M2_RVALID(), .M2_RREADY(1'b0),
    .M2_AWADDR(32'h0), .M2_AWPROT(3'b0), .M2_AWVALID(1'b0), .M2_AWREADY(),
...
// Busy Signal Outputs
// ==============================================================================
assign serv0_busy = serv0_busy_int;
assign serv1_busy = serv1_busy_int;

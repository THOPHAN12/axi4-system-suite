`timescale 1ns / 1ps
////////////////////////////////////////////////////////////////////////////////
// Module Name: arbiter_fixed_priority_tb
// Description: Comprehensive testbench for Write_Arbiter module
//              Tests Fixed Priority arbitration between 2 AXI masters
//
// Source File: src/axi_interconnect/rtl/arbitration/algorithms/arbiter_fixed_priority.v
// Module: Write_Arbiter
// Arbitration Policy: Fixed Priority (M0 > M1)
//
// Test Cases:
...
module arbiter_fixed_priority_tb();
    ...
    //==========================================================================
    initial begin
        $dumpfile("arbiter_fixed_priority_tb.vcd");
        $dumpvars(0, arbiter_fixed_priority_tb);
    end

...
////////////////////////////////////////////////////////////////////////////////
// Testcase 2: M1 win giao tiếp với RAM
// Description: Test arbitration when both M0 and M1 request RAM simultaneously
//              Expected: M1 wins arbitration and successfully communicates with RAM
////////////////////////////////////////////////////////////////////////////////

module testcase2_m1_ram;
    ...
    initial begin
        $display("========================================");
        $display("TESTCASE 2: M1 win giao tiếp với RAM");
        $display("========================================");
        ...
        // Create simultaneous requests - M1 requests first to win in round-robin
        repeat(5) begin
            @(posedge ACLK);
            S01_AXI_araddr = RAM_BASE;
            S01_AXI_arlen = 8'h0;
            S01_AXI_arsize = 3'b010;
            S01_AXI_arburst = 2'b01;
            S01_AXI_arvalid = 1'b1;
            
            S00_AXI_araddr = RAM_BASE + 4;
            S00_AXI_arlen = 8'h0;
        ...
        if (m1_read_count > 0 && m1_win_count > 0) begin
            $display("[%0t] TEST PASSED: M1 successfully communicated with RAM", $time);
        end else begin
            $display("[%0t] TEST FAILED: M1 did not win arbitration or communicate", $time);
            test_pass = 0;
        end

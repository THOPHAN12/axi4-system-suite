module Write_Addr_Channel_Dec #(
    ...
    input logic  [AXI4_Aw_len-1:0]        Master_AXI_awlen, // number of transfer per burst //! For AXI4 limit is 256 for inc bursts only 
    ...
    input logic  [3:0]                   Master_AXI_awcache, // a opptional signal for connecting to diffrent types of  memories
    ...
    output logic [3:0]                    M02_AXI_awcache,// a opptional signal for connecting to diffrent types of  memories
    ...
    output logic [3:0]                    M03_AXI_awcache,// a opptional signal for connecting to diffrent types of  memories
...
// Debug visibility removed - only keeping essential transaction information

...
#
# Script generated by Vivado on Sun Dec 21 01:02:06 +0700 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : comprehensive_system_tb.sh
...
#
# Usage        : comprehensive_system_tb.sh
#                comprehensive_system_tb.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                comprehensive_system_tb.sh [-reset_run]
#                comprehensive_system_tb.sh [-reset_log]
#                comprehensive_system_tb.sh [-help]
#
...
# set xvlog options
xvlog_opts="--incr --relax -sv -L uvm -L axi_vip_v1_1_19 -L zynq_ultra_ps_e_vip_v1_0_19 -L xilinx_vip"

# script info
echo -e "comprehensive_system_tb.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./comprehensive_system_tb.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug all --relax --mt 2  -L xil_defaultlib -L xilinx_vip -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip --snapshot comprehensive_system_tb xil_defaultlib.comprehensive_system_tb xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim comprehensive_system_tb -key {Behavioral:sim_1:Functional:comprehensive_system_tb} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Xilink/Vivado/2024.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb comprehensive_system_tb.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./comprehensive_system_tb.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: comprehensive_system_tb.sh [-help]\n\
Usage: comprehensive_system_tb.sh [-step]\n\
Usage: comprehensive_system_tb.sh [-lib_map_path]\n\
Usage: comprehensive_system_tb.sh [-reset_run]\n\
Usage: comprehensive_system_tb.sh [-reset_log]\n\
Usage: comprehensive_system_tb.sh [-keep_index]\n\
Usage: comprehensive_system_tb.sh [-noclean_files]\n\n\

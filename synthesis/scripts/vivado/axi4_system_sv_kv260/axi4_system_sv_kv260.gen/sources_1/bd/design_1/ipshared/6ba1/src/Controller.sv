module Controller (
    ...
    //input from logic file to indicate range of addresses of slave 0:
    input logic [31:0] slave0_addr1, 
    input logic [31:0] slave0_addr2,

    //input from logic file to indicate range of addresses of slave 1:
    input logic [31:0] slave1_addr1,
    input logic [31:0] slave1_addr2,

    //input from logic file to indicate range of addresses of slave 2:
    input logic [31:0] slave2_addr1,
    input logic [31:0] slave2_addr2,

    //input from logic file to indicate range of addresses of slave 3:
    ...
    output logic [1:0] en_S0, en_S1, en_S2, en_S3,
...
logic S0_busy = 0, S1_busy = 0, S2_busy = 0, S3_busy = 0;

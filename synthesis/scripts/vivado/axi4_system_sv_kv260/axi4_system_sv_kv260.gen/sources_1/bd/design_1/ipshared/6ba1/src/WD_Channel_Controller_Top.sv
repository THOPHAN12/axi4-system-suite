module WD_Channel_Controller_Top #(
 ...
 /*GOES TO THE BR CHANNEL*/
    ...
    input logic  [S01_Write_data_bytes_num-1:0]   S01_AXI_wstrb, // strops identifes the active data lines
...
// Debug: Monitor Write Data Channel
logic AW_Access_Grant_prev_wd, Master_Valid_1_prev, Master_Valid_2_prev, M01_AXI_wvalid_prev;
always_ff @(posedge ACLK or negedge ARESETN) begin
    if (!ARESETN) begin
        AW_Access_Grant_prev_wd <= 1'b0;
        Master_Valid_1_prev <= 1'b0;
        Master_Valid_2_prev <= 1'b0;
        M01_AXI_wvalid_prev <= 1'b0;
    end else begin
        AW_Access_Grant_prev_wd <= AW_Access_Grant;
        Master_Valid_1_prev <= Master_Valid_1;
        Master_Valid_2_prev <= Master_Valid_2;
        M01_AXI_wvalid_prev <= M01_AXI_wvalid;
    end
end

# run_slave_bridge_tb_auto.tcl
# Auto-run slave bridge testbench and check for 100% pass rate

set PROJECT_ROOT [file normalize [file join [file dirname [file dirname [file dirname [file dirname [file dirname [info script]]]]]]]]

puts "============================================================================"
puts "Running AXI Slave Bridge Testbench - Auto Check"
puts "============================================================================"
...
puts "Expected: 100% pass rate (all tests)"
puts ""

// AXI_Interconnect_Full_General.sv
// Initial copy of 2M×4S AXI_Interconnect_Full for generalization work.
// NOTE: Logic is currently identical to the original AXI_Interconnect_Full,
//       only module name is changed to keep the legacy design untouched.

`timescale 1ns/1ps

module AXI_Interconnect_Full_General #(
...
// Note: M0_data_wire, M1_data_wire, en_S0_wire, en_S1_wire already declared above
